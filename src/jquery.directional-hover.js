(function() {
    /**
     * Directional hover custom object.
     */
    var DirectionalHover = (function() {

        function DirectionalHover(elem, options) {
            $.extend(this, $(elem));
        ...
        return DirectionalHover;

    })();


    /**
     * Directional hover object public functions.
     */
    DirectionalHover.prototype.slideIn = function(side) {
        
    };

    DirectionalHover.prototype.slideOut = function(side) {
    ...
    (function ($) {
        ...
        $.fn.directionalHover = function(options) {
            return new DirectionalHover(this, options);
        }
